    ...
    <div class="p-5 bg-light border border-1 mb-5">
        <div class="form-group mb-3">
            ...
            <asp:TextBox ID="txtName" runat="server" CssClass="form-control mb-2"></asp:TextBox>
                ...
                Display="Dynamic"
                ValidationGroup="CreateAdventurerValidation">
        ...
        <div class="form-group mb-3">
            ...
            <asp:DropDownList ID="ddlType" runat="server" CssClass="form-select mb-2">
                <asp:ListItem Value="">Select a type...</asp:ListItem>
                    ...
                    <asp:RequiredFieldValidator ID="requireType" runat="server"
        ...
        <asp:Button ID="btnCreateAdventurer" runat="server" Text="Create Adventurer" CssClass="btn btn-primary" OnClick="btnCreateAdventurer_Click" ValidationGroup="CreateAdventurerValidation" />
    </div>
